...
AMIFEDORAATOMIC = envd("AWS_AMI_FEDORA_AOMIC", "ami-095734cd6327f5b58") # fedora atcomic 28/us-east-1
AMICENTOSATOMIC = envd("AWS_AMI_CENTOS", "ami-08501d64") # centos atomic 7/us-east-1
